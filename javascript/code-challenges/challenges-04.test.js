...
const sortNumbers = (arr) => {
  // Solution code here...
  return arr.sort(function(no1,no2){return no1-no2;});
};

/* ------------------------------------------------------------------------------------------------
CHALLENGE 4

Write a function named sortBackwards that takes in an array of numbers and returns the same array, with the numbers sorted,
 largest to smallest.
...
const sortBackwards = (arr) => {
  // Solution code here...
  return arr.sort(function(no1,no2){return no2-no1;});
};
...
const sortByPrice = (arr) => {
  // Solution code here...
  arr.sort((no1,no2)=>{return no1.price -no2.price;});
  return arr;
};
